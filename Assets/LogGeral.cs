...
public class LogGeral : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        path = Application.dataPath + "/" + participantName + "_" + DateTime.Now.ToString("MM/dd/yyyy HH:mm").Replace(":", ".").Replace("/", ".") + "_" + evaluation.condition + "_LogGeneral" + ".txt";
        //File.Create(path);
    }
